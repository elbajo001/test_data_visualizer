  ...
  return (
    <div className="container_form-tasks">
      <div className="flex flex-row justify-between transition-all">
        ...
        <i
          className="bi bi-caret-down-fill flex justify-center items-center cursor-pointer md:hidden"
          style={{
            fontSize: "1.225rem",
            transform: `${props?.showForm ? "rotateZ(180deg)" : "rotateZ(0deg)"}`,
          }}
      ...
      <form
        className={`flex flex-col w-full ${props?.showForm ? 'flex' : 'hidden'} md:flex`}

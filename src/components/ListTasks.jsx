  ...
  return (
    <div className="container_list-tasks">
        ...
        >
          ...
          {props?.filter === "all" ? (
            <i
              ...
              style={{
                fontSize: "10px",
                transform: props?.orderAsc ? "rotateY(180deg)" : "rotateY(0deg)",
              }}
            ></i>
          ) : null}
        </div>
      ...
      <div className="container_list-tasks ring-2 p-1 pt-4 lg:px-4 rounded-md ring-gray-100 mt-[-0.9rem] -z-10 block">
        {props?.tasksFiltered ? props?.tasksFiltered(props?.tasks?.tasks, props?.filter)?.map((t, index) => (
          <div
          ...
          >
            <form
              ...
              className={`
                    ...
                    flex gap-2 p-2 w-full rounded-md ring-1 transition-all ring-${t?.priority?.color}-300 bg-${t?.priority?.color}-50
                  `}
            >
              <input
                type="checkbox"
            ...
            <div className="flex justify-between items-center h-full">
              <div
                onClick={() => props?.handleChangeTask(index, t?.title, "edit")}
                className={`
